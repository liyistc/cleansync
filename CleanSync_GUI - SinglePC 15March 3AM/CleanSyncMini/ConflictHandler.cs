   ...
   public class ConflictHandler
    {
        ...
        public ComparisonResult handleConflicts(ComparisonResult comparisonResult, int[] userChoice)
        {
            ...
            private void handleFolderConflict(Differences differencesToBeUpdated , Conflicts folderConflict, int USBorPCIndex)
            {
                ...
                LogFile.ReportSolvedConflicts("FolderConflict: ", folderConflict.CurrentPCFolder.AbsolutePath, folderConflict.USBFolder.AbsolutePath, FolderToBeUpdated.AbsolutePath);
                switch(conflictType){
            ...
            private void handleFileConflict(Differences differencesToBeUpdated, Conflicts fileConflict, int USBorPCIndex)
            {
                ...
                LogFile.ReportSolvedConflicts("FolderConflict: ", fileConflict.CurrentPCFile.AbsolutePath, fileConflict.USBFile.AbsolutePath, FileToBeUpdated.AbsolutePath);
                switch (conflictType)
                {
                    case Conflicts.ConflictType.Deleted:
