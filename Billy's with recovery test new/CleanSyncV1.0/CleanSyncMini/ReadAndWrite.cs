...
namespace CleanSync
{
    ...
    {
        /*Billy's added methods*/
        public static void MoveFileOrFolder(string source, string target)
        {
        ...
        public static void MoveFileOrFolderContents(string source, string target)
        {
            ...
            foreach (string fileDir in fileEntries)
            {
                ...
                MoveFileOrFolder(fileDir, target + @"\" + file.Name);
            }
            string[] subdirEntries = Directory.GetDirectories(source);
            foreach (string subdir in subdirEntries)
            {
                MoveFileOrFolder(subdir, target + @"\" + subdir.Substring(subdir.LastIndexOf(@"\")));
            }
        }
        //end added methods
