...
namespace CleanSyncMini
{
    public static class ReadAndWrite
    {
        ...
        public static void RenameFolder(string originalPath, string newPath)
        {
        ...
        {
            if (!Directory.Exists(GetUSBRootPath(USBPath) + @"\incompleteJobs"))
                Directory.CreateDirectory(GetUSBRootPath(USBPath) + @"\incompleteJobs");
            return GetUSBRootPath(USBPath) + @"\incompleteJobs";
        }
        ...
        {
            return Path.GetPathRoot(usbPath) + @"\usb";
        }
